...
namespace DemoTreeView.UserControl
{
	...
	public class TestDrawingOptions : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.gtv.TabIndex = 0;
			this.gtv.OnAfterCellPainting += new Genius.Controls.OnPaintNodeDelegate(this.gtv_OnAfterCellPainting);
			this.gtv.OnBeforeNodePainting += new Genius.Controls.OnPaintNodeDelegate(this.gtv_OnBeforeNodePainting);
			this.gtv.OnDrawTreeLines += new Genius.Controls.OnDrawingNodeTreeLinesDelegate(this.gtv_OnDrawTreeLines);
			// 
			// TestDrawingOptions
			// 
		...
		private void gtv_OnAfterCellPainting(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
			//e.Info.DrawingOptions = DrawingOption.HideTreeLines;
		}

		private void gtv_OnDrawTreeLines(Genius.Controls.GeniusTreeView Sender, Genius.Controls.NodeDrawingTreeLinesEventArgs e)
		{
