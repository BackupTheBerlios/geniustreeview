...
namespace DemoTreeView.UserControl
{
	...
	public class TestVisibility : System.Windows.Forms.UserControl
	{
		...
		private Genius.Controls.GeniusTreeView gtv;
		...
		private void InitializeComponent()
		{
			...
			this.gtv = new Genius.Controls.GeniusTreeView();
			...
			this.pnlHaut.Size = new System.Drawing.Size(360, 64);
			...
			this.panel1.Size = new System.Drawing.Size(360, 248);
			...
			this.gtv.DefaultDrawingOption = Genius.Controls.DrawingOption.ShowGridLines;
			...
			this.gtv.HeaderColonnes.AddRange(new Genius.Controls.GeniusTreeViewColonne[] {
			...
			this.gtv.Size = new System.Drawing.Size(360, 248);
			this.gtv.TabIndex = 0;
			this.gtv.Text = "geniusTreeView1";
			this.gtv.UseColumns = true;
			this.gtv.OnGetHint += new Genius.Controls.OnGetHintDelegate(this.gtv_OnGetHint);
			this.gtv.OnGetNodeValue += new Genius.Controls.OnGetNodeValueForComparisonDelegate(this.gtv_OnGetNodeValue);
			this.gtv.OnGetNodeText += new Genius.Controls.OnGetNodeTextDelegate(this.gtv_OnGetNodeText);
			this.gtv.OnInitNode += new Genius.Controls.OnNodeDelegate(this.gtv_OnInitNode);
			// 
			// contextMenu1
			// 
		...
		private void gtv_OnInitNode(Genius.Controls.GeniusTreeView Sender, Genius.Controls.NodeEventArgs e)
		{
		...
		private System.IComparable gtv_OnGetNodeValue(Genius.Controls.TreeView.Core.INode A, int aDisplayColumn)
		{
			return A.Text;
		}

		private void gtv_OnGetHint(Genius.Controls.GeniusTreeView Sender, Genius.Controls.NodeGetHintEventArgs e)
		{
		...
		private void gtv_OnGetNodeText(Genius.Controls.GeniusTreeView Sender, Genius.Controls.NodeTextEventArgs e)
		{
