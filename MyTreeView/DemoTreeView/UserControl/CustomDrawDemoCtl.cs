...
namespace Genius.Controls.UserControl
{
	...
	public class CustomDrawDemoCtl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.geniusTreeView1.SearchDirection = Genius.Controls.SearchDirectionEnum.Forward;
			...
			this.geniusTreeView1.OnBeforeCellPainting += new Genius.Controls.OnPaintNodeDelegate(this.geniusTreeView1_OnBeforeCellPainting);
			this.geniusTreeView1.OnAfterCellPainting += new Genius.Controls.OnPaintNodeDelegate(this.geniusTreeView1_OnAfterCellPainting);
			this.geniusTreeView1.OnBeforeNodePainting += new Genius.Controls.OnPaintNodeDelegate(this.geniusTreeView1_OnBeforeNodePainting);
		...
		private void geniusTreeView1_OnBeforeNodePainting(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
		...
		private void geniusTreeView1_OnBeforeCellPainting(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
			if (e.Node.Index != 9)
			{
		...
		private void geniusTreeView1_OnAfterCellPainting(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
			if (e.Node.Index == 9)
			{
