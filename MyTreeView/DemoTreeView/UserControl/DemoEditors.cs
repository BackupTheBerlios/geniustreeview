...
namespace DemoTreeView.UserControl
{
	...
	public class DemoEditors : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.geniusTreeView1.OnInitEdit += new Genius.Controls.OnInitEditDelegate(this.geniusTreeView1_OnInitEdit);
			this.geniusTreeView1.OnCreateEditor += new Genius.Controls.OnCreateEditorDelegate(this.geniusTreeView1_OnCreateEditor);
			this.geniusTreeView1.OnAfterCheck += new Genius.Controls.OnNodeDelegate(this.geniusTreeView1_OnAfterCheck);
			this.geniusTreeView1.OnBeforeEdit += new Genius.Controls.OnCanEditDelegate(this.geniusTreeView1_OnBeforeEdit);
			this.geniusTreeView1.OnAfterEdit += new Genius.Controls.OnAfterEditDelegate(this.geniusTreeView1_OnAfterEdit);
			// 
