...
namespace DemoTreeView.UserControl
{
	...
	public class TestDataSource : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.gtv.OnBeforeNodePainting += new Genius.Controls.OnPaintNodeDelegate(this.gtv_OnBeforeNodePainting);
			this.gtv.OnBeforeCellPainting += new Genius.Controls.OnPaintNodeDelegate(this.gtv_OnBeforeCellPainting);
		...
		private void gtv_OnBeforeNodePainting(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
			//
		}

		private void gtv_OnBeforeCellPainting(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
