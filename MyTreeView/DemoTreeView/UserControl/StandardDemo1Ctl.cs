...
namespace Genius.Controls.UserControl
{
	...
	public class StandardDemo1Ctl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.geniusTreeView1.OnBeforeCellPainting += new Genius.Controls.OnPaintNodeDelegate(this.geniusTreeView1_OnDrawCellNode);
			this.geniusTreeView1.OnBeforeExpand += new Genius.Controls.OnExpandDelegate(this.geniusTreeView1_OnBeginExpand);
			this.geniusTreeView1.OnGetNodeText += new Genius.Controls.OnGetNodeTextDelegate(this.geniusTreeView1_OnGetNodeText);
			this.geniusTreeView1.OnCreateHintWindow += new Genius.Controls.OnCreateHintWindowDelegate(this.geniusTreeView1_OnCreateHintWindow);
		...
		private void geniusTreeView1_OnBeginExpand(Genius.Controls.GeniusTreeView Sender, Genius.Controls.ExpandEventArgs e)
		{
		...
		private void geniusTreeView1_OnDrawCellNode(Genius.Controls.GeniusTreeView Sender, Genius.Controls.PaintNodeEventArgs e)
		{
			int colindex;
			...
			else if (colindex == 1)
			{
				...
				{
					selected = true;
					geniusTreeView1.DrawSelectedRectangle(e.Info.graphics, e.Info.NodeRect, true);
				}
				r.Y += 1;
				r.Height -= 1;
				r.Inflate(-2,-5);
		...
		private void geniusTreeView1_OnCreateHintWindow(Genius.Controls.GeniusTreeView Sender, Genius.Controls.NodeHintWindowEventArgs e)
		{
