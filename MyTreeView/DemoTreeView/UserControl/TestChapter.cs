...
namespace DemoTreeView.UserControl
{
	...
	public class TestChapter : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.geniusTreeView1.DefaultDrawingOption = Genius.Controls.DrawingOption.Default;
		...
		private void TestChapter_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				geniusTreeView1.OnGetFontNode +=new Genius.Controls.OnNodeFontDelegate(geniusTreeView1_OnGetFontNode);
		...
		private void geniusTreeView1_OnGetFontNode(Genius.Controls.GeniusTreeView Sender, Genius.Controls.NodeFontEventArgs e)
		{
			if (e.Node.Level == 1)
			{
